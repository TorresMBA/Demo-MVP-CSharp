    ...
    .footer {
        ...
        <div>
            ...
            <div class="container">
                            ...
                            <tbody>
                                <asp:Repeater ID="ProgramasAfiliados" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <asp:CheckBox CssClass="test" ID="cbkPrograma" runat="server" OnLoad="cbkPrograma_Load" OnCheckedChanged="cbkPrograma_CheckedChanged"/>
                ...
                <div class="footer">
                    <input  type="submit" value="Aceptar" class="button-aceptar" />
                </div>
            </div>
        </div>
    </form>
